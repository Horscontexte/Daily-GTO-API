...
exports.create = (req, res) => {
    ...
    const gto = new Gto({
        ...
        heroRange: req.body.heroRange,
        vilainRange_percent: req.body.vilainRange_percent,
        heroRange_percent: req.body.heroRange_percent,
        type: req.body.type,
        position: req.body.position,
        pot: req.body.pot,
        heroStack: req.body.heroStack,
        vilainStack: req.body.vilainStack,
        vilainBetSize: req.body.vilainBetSize,
        ...
        checkRaise: req.body.checkRaise,
        bet: req.body.bet,
